...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleTierLimit(
            TierLimitExceededException ex, HttpServletRequest request) {
        // 402 Payment Required — the semantically correct status for "upgrade your plan"
        return build(HttpStatus.PAYMENT_REQUIRED, ex.getMessage(), request.getRequestURI());
    }
